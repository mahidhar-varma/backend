...
import validators
from src.database import documentModel, db
...
@documents.route('/<string:category>', methods=['POST', 'GET', 'DELETE'])
# @jwt_required()
...
@documents.route('/<string:category>/<string:documentId>', methods=['POST', 'GET', 'PATCH', 'DELETE', 'PUT'])
...
@documents.get("/<string:userId>/stats")
# @jwt_required()
