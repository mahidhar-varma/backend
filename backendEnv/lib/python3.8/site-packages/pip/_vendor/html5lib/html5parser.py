    ...
    class InBodyPhase(Phase):
        ...
        def endTagFormatting(self, token):
            ...
            while outerLoopCounter < 8:
                ...
                # Step 8:
                # The document is supposed to help us identify where to reinsert
                # nodes in step 15. We have to ensure that we reinsert nodes after
                # the node before the active formatting element. Note the document
                # can move in step 9.7
                document = self.tree.activeFormattingElements.index(
                    formattingElement)
                ...
                self.tree.activeFormattingElements.insert(document, clone)
